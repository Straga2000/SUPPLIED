...
class siteFunctions:
    ...
    def delete_product(self, id, name):
        self.userList[id].product_list.delete_product(name)

    def get_week_forecast(self, id):
        self.userList[id].product_list.get_expense_over_a_week()

    def get_month_forecast(self, id):
        self.userList[id].product_list.get_expense_over_a_month()
